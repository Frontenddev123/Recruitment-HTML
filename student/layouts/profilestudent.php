        ...
        <div class="col-md-4">
           ...
           <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div class="row mt-2 align-items-center">
                    <div class="col-md-6"> <h5>Napoli</h5></div>
                    <div class="col-md-6 mb-5"> <a href="#" class="btn btn-light">view</a></div>
                    <hr style="width:700px", float="center", color=black >  
                    <div class="col-md-6"> <h5>Napoli</h5></div>
                    <div class="col-md-6 mb-5"> <a href="#" class="btn btn-light">Waiting</a></div>
                    <hr style="width:700px", float="center", color=black > 
                    <div class="col-md-6"> <h5>Napoli</h5></div>
                    <div class="col-md-6 mb-5"> <a href="#" class="btn btn-light">Not Approved</a></div> 
