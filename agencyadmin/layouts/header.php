...
<html lang="en">
	...
	<head><base href="">
		...
		<meta charset="utf-8" />
		<meta name="description" content="Recruitment Company" />
		<meta name="keywords" content="Recruitment Company" />
		<meta name="viewport" content="width=device-width, initial-scale=1" />
		<meta property="og:locale" content="AL_US" />
					...
					<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
						...
						<div class="container-xxl d-flex flex-grow-1 flex-stack">
							...
							<div class="d-flex align-items-center me-5">
								...
								<img alt="Logo" src="assets/media/logos/logo_header.png" class=" h-20px h-lg-30px" />
